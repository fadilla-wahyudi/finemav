...
### GUI version
We recently released the GUI version of *FineMAV* for Linux. For more information on how to install and run the software, please visit our [wiki](https://github.com/fadilla-wahyudi/finemav/wiki/5.-GUI-version-(Linux)).
